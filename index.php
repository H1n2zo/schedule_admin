 ...
 * Home Page - Updated with External Assets
 * File: index.php
 */
...
$pageTitle = 'EVSU Event Management System';
$customCSS = []; // Uses only global styles
$customJS = []; // Uses only global JS
...
<?php
// Add inline styles for this page only
$inlineStyles = "
<style>
    /* Hero Section */
    .hero-section {
